        ...
        <div className="container-narrow">
          ...
          <div className="glass-card p-8 md:p-12 max-w-3xl mx-auto">
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                Digital Civics Hub was born from a simple yet powerful observation: too many talented 
                professionals were stuck in the cycle of consuming digital content rather than creating it.
              </p>
              <p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="aspect-square rounded-2xl overflow-hidden border-2 border-primary/20">
                  <img 
                    src={jerryImage} 
                    alt="Jeremiah Adeyemi - Founder of Digital Civics Hub" 
