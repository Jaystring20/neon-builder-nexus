      ...
      <div className="container-narrow relative z-10">
        <div className="glass-card-elevated p-8 md:p-16 text-center overflow-hidden relative hover-glow glass-border">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold mb-6 opacity-0 animate-fade-in-up-elegant">
              Ready to <span className="gradient-text">Build Your Future?</span>
            </h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed opacity-0 animate-fade-in-up-elegant animation-delay-100">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 opacity-0 animate-fade-in-up-elegant animation-delay-200">
            ...
            {/* Contact Info */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-muted-foreground opacity-0 animate-fade-in-up-elegant animation-delay-300">
