        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1 flex flex-col items-center">
            <Dialog>
              ...
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto glass-card-elevated border-border/50">
                ...
                <div className="space-y-6 pt-4">
                  ...
                  {/* Quote */}
                  <div className="glass-card-elevated p-5 border-l-4 border-l-secondary">
                  ...
                  {/* Connect Button */}
                  <Button variant="hero" size="lg" asChild className="w-full hover-glow">
                    <a 
            ...
            <ScrollReveal animation="fade-up" delay={200}>
              <Button variant="heroOutline" size="lg" asChild className="mt-8 hover-glow">
                <a 
                  href="https://thedigitechstrategist.lovable.app" 
                  target="_blank" 
                  rel="noopener noreferrer" 
